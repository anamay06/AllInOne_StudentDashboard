// ============================================
// ACADEMICS MODULE - Sample Data & Helpers
// Branch: academics
...
export function getGradeColor(grade) {
  if (grade.startsWith('A')) return 'academics-grade-badge-A';
  if (grade.startsWith('B')) return 'academics-grade-badge-B';
  if (grade.startsWith('C')) return 'academics-grade-badge-C';
  return 'academics-grade-badge-D';
}
...
export function getOverallAttendance(courses) {
  ...
  const total = courses.reduce((sum, c) => sum + c.attendance, 0);
